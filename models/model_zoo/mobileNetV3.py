...
"""
    https://github.com/chansoopark98/

    MobileNet v3 small models for TensorflowKeras.
    # Reference
    Thanks for [Searching for MobileNetV3]
...
class MobileNetV3_Small(MobileNetBase):
    ...
    def build(self):
        ...
        x = self._conv_block(inputs, 16, (3, 3), strides=(1, 1), nl='HS')
