...
parser.add_argument("--result_path",     type=str,   help="raw image path", default='./data_labeling/data/032155_white_50cm/result/augmentation/')
...
if __name__ == '__main__': 
    ...
    for idx in range(len(rgb_list)):
        ...
        name = rgb_list[idx].split('/')[3] + '_' + str(i)
